...
import com.walaida.springbootinit.model.dto.useranswer.UserAnswerAddRequest;
import com.walaida.springbootinit.model.dto.useranswer.UserAnswerEditRequest;
import com.walaida.springbootinit.model.dto.useranswer.UserAnswerQueryRequest;
import com.walaida.springbootinit.model.dto.useranswer.UserAnswerUpdateRequest;
...
import com.walaida.springbootinit.model.vo.UserAnswerVO;
import com.walaida.springbootinit.scoring.ScoringStrategy;
import com.walaida.springbootinit.scoring.ScoringStrategyExecutor;
import com.walaida.springbootinit.service.AppService;
import com.walaida.springbootinit.service.UserAnswerService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if(!ReviewStatusEnum.PASS.equals(ReviewStatusEnum.getEnumByValue(app.getReviewStatus()))){
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"该应用未通过审核，无法答题！");
    ...
    public BaseResponse<Boolean> updateUserAnswer(@RequestBody UserAnswerUpdateRequest userAnswerUpdateRequest) {
        if (userAnswerUpdateRequest == null || userAnswerUpdateRequest.getAppId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        // todo 在此处将实体类和 DTO 进行转换
        UserAnswer userAnswer = new UserAnswer();
        ...
        // 判断是否存在
        long id = userAnswerUpdateRequest.getAppId();
        UserAnswer oldUserAnswer = userAnswerService.getById(id);
        ThrowUtils.throwIf(oldUserAnswer == null, ErrorCode.NOT_FOUND_ERROR);
        // 操作数据库
